...
public class CommandDebug extends CommandBase
{
    ...
    private String getProfileResults(long timeSpan, int tickSpan)
    {
        ...
        stringbuilder.append("// This is approximately ").append(String.format("%.2f", 
        		new Object[] {(float)tickSpan / ((float)timeSpan / 1000.0F)})).append(" ticks per second. It should be ").append((int)20).append(" ticks per second\n\n");
    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder stringBuilder)
    {
        ...
        if (list != null && list.size() >= 3)
        {
            for (int i = 1; i < list.size(); ++i)
            {
                ...
                stringBuilder.append(profiler$result.field_76331_c).append(" - ").append(String.format("%.2f", 
                		new Object[] {profiler$result.field_76332_a})).append("%/").append(String.format("%.2f", 
                				new Object[] {profiler$result.field_76330_b})).append("%\n");

...
public class WorldInfo
{
    ...
    {
        this.worldTime = Nightmare.instance.moduleManager.getModuleByName("TimeChanger").isToggled() ? (int) Nightmare.instance.settingsManager.getSettingByName(Nightmare.instance.moduleManager.getModuleByName("TimeChanger"), "Time").getValDouble() : time;
    }

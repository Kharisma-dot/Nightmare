...
public class GuiConfirmOpenLink extends GuiYesNo
{
    ...
    public void initGui()
    {
        ...
        int x1 = (this.width >> 1) - 50;
        int y1 = this.height / 6 + 96;
        
        this.buttonList.add(new GuiButton(0, x1 - 105, y1, 100, 20, this.confirmButtonText));
        this.buttonList.add(new GuiButton(2, x1, y1, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new GuiButton(1, x1 + 105, y1, 100, 20, this.cancelButtonText));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.showSecurityWarning)
            this.drawCenteredString(this.fontRendererObj, this.openLinkWarning, this.width >> 1, 110, 16764108);
    }

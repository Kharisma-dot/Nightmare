...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventPreMotionUpdate eventPreMotionUpdate = new EventPreMotionUpdate(Minecraft.getMinecraft().thePlayer.rotationYaw, Minecraft.getMinecraft().thePlayer.rotationPitch, Minecraft.getMinecraft().thePlayer.onGround, Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY, Minecraft.getMinecraft().thePlayer.posZ);
        ...
        {
            double d0 = eventPreMotionUpdate.getX() - this.lastReportedPosX;
            double d1 = eventPreMotionUpdate.getY() - this.lastReportedPosY;
            double d2 = eventPreMotionUpdate.getZ() - this.lastReportedPosZ;
            double d3 = eventPreMotionUpdate.getYaw() - this.lastReportedYaw;
            double d4 = eventPreMotionUpdate.getPitch() - this.lastReportedPitch;
            ...
            if (flag2) {
                this.lastReportedPosX = eventPreMotionUpdate.getX();
                this.lastReportedPosY = eventPreMotionUpdate.getY();
                this.lastReportedPosZ = eventPreMotionUpdate.getZ();
    ...
    public void sendChatMessage(String message)
    {
    	...
    	Nightmare.instance.commandManager.handleChat(event);
    ...
    public void onLivingUpdate()
    {
        ...
        {
        	if(Nightmare.instance.moduleManager.getModuleByName("NoSlow").isDisabled() || (Nightmare.instance.moduleManager.getModuleByName("AutoClicker").isToggled() && !Nightmare.instance.settingsManager.getSettingByName(Nightmare.instance.moduleManager.getModuleByName("AutoClicker"), "AutoBlock").getValBoolean())) {

...
public class BlockPattern
{
    ...
    {
        LoadingCache<BlockPos, BlockWorldState> loadingcache = load(worldIn, false);
    ...
    public static LoadingCache<BlockPos, BlockWorldState> load(World world, boolean forceLoad)
    {
        return CacheBuilder.newBuilder().<BlockPos, BlockWorldState>build(new BlockPattern.CacheLoader(world, forceLoad));
    }
    ...
    static class CacheLoader extends com.google.common.cache.CacheLoader<BlockPos, BlockWorldState>
    {
        ...
        public CacheLoader(World worldIn, boolean forceLoad)
        {
            this.world = worldIn;
        ...
        {
            return new BlockWorldState(this.world, pos, this.forceLoad);
        }
    }
    ...
    public static class PatternHelper
    {
        ...
        public PatternHelper(BlockPos posIn, EnumFacing fingerIn, EnumFacing thumbIn, LoadingCache<BlockPos, BlockWorldState> lcacheIn, int width, int height, int depth)
        {
            this.pos = posIn;

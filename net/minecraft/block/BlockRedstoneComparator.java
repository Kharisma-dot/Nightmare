...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider
{
    ...
    public BlockRedstoneComparator(boolean powered)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH)
        		...
        		.withProperty(MODE, Mode.COMPARE));
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        return Blocks.powered_comparator.getDefaultState()
        		...
        		.withProperty(MODE, unpoweredState.getValue(MODE));
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        return Blocks.unpowered_comparator.getDefaultState()
        		...
        		.withProperty(MODE, poweredState.getValue(MODE));
    }
    ...
    {
        return state.getValue(MODE) == Mode.SUBTRACT ? 
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSoundEffect((double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D, 
            		"random.click", 0.3F, state.getValue(MODE) == Mode.SUBTRACT ? 0.55F : 0.5F);
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        return this.getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta))
        		...
        		.withProperty(MODE, (meta & 4) > 0 ? Mode.SUBTRACT : Mode.COMPARE);
    }

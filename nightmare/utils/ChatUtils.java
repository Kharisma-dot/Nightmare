...
public enum ChatUtils
{
    ...
    private static final Map<String, ChatUtils> nameMapping = Maps.<String, ChatUtils>newHashMap();
    ...
    private ChatUtils(String formattingName, char formattingCodeIn, int colorIndex)
    {
        this(formattingName, formattingCodeIn, false, colorIndex);
    }

    private ChatUtils(String formattingName, char formattingCodeIn, boolean fancyStylingIn)
    {
        this(formattingName, formattingCodeIn, fancyStylingIn, -1);
    }

    private ChatUtils(String formattingName, char formattingCodeIn, boolean fancyStylingIn, int colorIndex)
    {
     ...
     */
    public static ChatUtils getValueByName(String friendlyName)
    {
        return friendlyName == null ? null : (ChatUtils)nameMapping.get(func_175745_c(friendlyName));
    }

    public static ChatUtils func_175744_a(int p_175744_0_)
    {
        if (p_175744_0_ < 0)
        {
            return RESET;
        ...
        {
            for (ChatUtils enumchatformatting : values())
            {
